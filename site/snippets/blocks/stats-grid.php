        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-0 border-y border-white/10">
            <?php foreach ($block->stats()->toStructure() as $stat): ?>
                <div
                    ...
                    <span class="block text-xs font-bold text-[var(--accent)] uppercase tracking-[0.2em] mb-6">
                        <?= $stat->label() ?>
                    </span>
                    <h2 class="text-6xl md:text-7xl font-black text-white mb-0 tracking-tight"
